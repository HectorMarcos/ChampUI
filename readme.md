...
7. Press `Import Profile` again and copy and paste [ElvUI Private Settings](https://github.com/HectorMarcos/ChampUI/blob/master/profiles/elvui_private.txt?raw=true), press `Import Now` again, now you can close ElvUI Config Panel.
